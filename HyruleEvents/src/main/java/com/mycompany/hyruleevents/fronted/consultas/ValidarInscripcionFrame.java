 ...
 * @author edu
 */
public class ValidarInscripcionFrame extends javax.swing.JInternalFrame {
     ...
     */
    public ValidarInscripcionFrame(EjecutadorDeInstruccionesFrontend ejecutador, ConsultasFrame framePadre) {
        initComponents();
    ...
    private void btnContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinuarActionPerformed
        ...
        boolean todoBien = true;
         try {
             this.ejecutador.validarInscripcion(parametros);
